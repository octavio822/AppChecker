# AppChecker
<br/>Verifica que los procesos se esten ejecutando de manera correcta basado en archivo <b>config.json</b>
...
<br/>Verify if the proccess are Process working in machine included in file <b>config.json</b>
