# AppChecker
<br/>Verifica que los procesos se esten ejecutando de manera correcta basado en archivo settings.json
...
<br/>Verify if the proccess are Process working in machine included in file settings.json
